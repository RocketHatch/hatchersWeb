...
HPROG.map.codeAddress = function() {
...
HPROG.map.toggleHeatmap = function() {
  if (heatmap == null) {
    var pointarray = new google.maps.MVCArray(eData);
...
HPROG.map.changeGradient = function() {
  var gradient = [
    'rgba(0, 255, 255, 0)',
    'rgba(0, 255, 255, 1)',
    'rgba(0, 191, 255, 1)',
...
HPROG.map.changeRadius = function()  {
  heatmap.setOptions({radius: heatmap.get('radius') ? null : 20});
}

HPROG.map.changeOpacity = function()  {
